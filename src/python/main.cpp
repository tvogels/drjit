...
PYBIND11_MODULE(drjit_ext, m_) {
    ...
    py::enum_<JitFlag>(m, "JitFlag", py::arithmetic())
        ...
        .value("ShaderExecutionReordering",         JitFlag::ShaderExecutionReordering)
        .value("OnlyReorderIfNonCoherent",          JitFlag::OnlyReorderIfNonCoherent)
        .value("DoNotReorderShadowRays",            JitFlag::DoNotReorderShadowRays)
        .value("ReorderBeforeVCalls",               JitFlag::ReorderBeforeVCalls)
        .value("ReorderVCallOnlyIfMultipleTargets", JitFlag::ReorderVCallOnlyIfMultipleTargets)
        .value("UseInstanceIdInVCallReorder",       JitFlag::UseInstanceIdInVCallReorder)
